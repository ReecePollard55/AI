...
def preprocess(x, target_size=(10, 10)):
    ...
    :return: The updated data matrix (n, num_rows, num_columns, num_channels)
    """
...
def assemble_results(output_root, param_grid_names):
    ...
    csv_file = os.path.join(output_root, 'results12.csv')
